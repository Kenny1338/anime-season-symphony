...
const Klamotten = () => {
  ...
  const products = [
    ...
    {
      id: 'kl-004',
      name: 'One Piece Strohhut Piraten T-Shirt',
      anime: 'One Piece',
      price: 34.99,
      originalPrice: 44.99,
      image: 'https://images.pexels.com/photos/8088495/pexels-photo-8088495.jpeg?auto=compress&cs=tinysrgb&w=400',
      ...
      isLimited: false,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      colors: ['Schwarz', 'Weiß', 'Navy']
    },
    {
      id: 'kl-005',
      name: 'Demon Slayer Tanjiro Haori Jacke',
      anime: 'Demon Slayer',
      price: 119.99,
      image: 'https://images.pexels.com/photos/7991225/pexels-photo-7991225.jpeg?auto=compress&cs=tinysrgb&w=400',
      rating: 4.9,
    ...
    {
      id: 'kl-006',
      name: 'Jujutsu Kaisen Gojo Sensei Uniform',
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span>/</span>
          <span className="text-foreground">Klamotten</span>
        </nav>

        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Anime Klamotten</h1>
          <p className="text-muted-foreground text-lg">
            Hochwertige Kleidung von deinen Lieblings-Anime-Serien
          </p>
        </div>
